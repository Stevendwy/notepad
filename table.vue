<template>
  <div class="hub-result-container">
    <div class="hub-filter">
      ...
      <el-button size="small" @click="handleTypeToDo('delete')">删除</el-button>
      <el-button size="small" @click="handleTypeToDo('online')">上线</el-button>
      <el-button size="small" @click="handleTypeToDo('leaveline')">下线</el-button>
    </div>   
...
<el-checkbox-group v-model="checkedCities" @change="handleCheckedCitiesChange">
        <div class="hrc-row"
          ...
          <div class="hrcr-item">
            <div class="edit">
              <button v-if="isOnline(item)" @click="offline({online: 0, item})">下线</button>
              <button v-else @click="online({online: 1, item})">上线</button>

              <button v-if="isSailing(item) || item.share_requesting" @click='cancelSale(item)'>取消特卖</button>
              <button v-else @click='applySale(item)'>申请特卖</button>
            </div>
          </div>
        </div>
        <el-dialog
    ...
    <div class="sale-null" v-else>
        <img src="/static/img/p_kucun.png" alt="">
    </div>
...
export default {
  ...
  computed: {
    ...Vuex.mapState("hub", ["resultList", "total_page", "bch"]),
    ...Vuex.mapGetters("hub", ["getEventList"])
    
  },
  methods: {
    ...Vuex.mapMutations("hub", ["updateCurrentReq"]),
    ...Vuex.mapActions("hub", [
      "aList",
      "online",
      "offline",
